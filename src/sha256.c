...
uint8_t Fu8__sha256(blob_t *ptr_sstc_pssd_blob_input, blob_t *ptr_sstc_pssd_blob_output)
    ...
    */ 
    u64_lcl_number_of_block_in_the_input_message = ptr_sstc_pssd_blob_input->u64_length_data_blob_ / SHA256_BLOCK_SIZE_IN_BYTE;

    /**
    * Check if the modulo of the length of the input message by the sha256 block size is not zero
    */
    if((ptr_sstc_pssd_blob_input->u64_length_data_blob_ % SHA256_BLOCK_SIZE_IN_BYTE) != 0)
        {
        /**
        ...
        if(u8_lcl_block_carry_padding_flag != FALSE)
            ...
            */ 
            ...
            while(u64_lcl_cnt < SHA256_BLOCK_SIZE_IN_BYTE)
                ...
                */
                if(((u64_lcl_actual_block_number * SHA256_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt) >= ptr_sstc_pssd_blob_input->u64_length_data_blob_)
                    {
                    /**
                    ...
                    */
                    ...
                    u8_lcl_message_block[u64_lcl_cnt] = ptr_sstc_pssd_blob_input->ptr_u8_data_blob_[(u64_lcl_actual_block_number * SHA256_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt];
                    }
    ...
    */
    u8_lcl_return_from_function = RETURN_FAILURE;
    u8_lcl_return_from_function = Fu8__preset_data_of_structure_blob_from_passed_eight_u32(ptr_sstc_pssd_blob_output, u32_lcl_A_block_data, u32_lcl_B_block_data, u32_lcl_C_block_data, u32_lcl_D_block_data, u32_lcl_E_block_data, u32_lcl_F_block_data, u32_lcl_G_block_data, u32_lcl_H_block_data);
